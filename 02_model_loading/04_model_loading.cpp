...
int main()
{
    ...
    Model ourModel("../data/photogrammetry-test-cg/teste.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 model;
        model = glm::translate(model, glm::vec3(0.9f, -0.5f, -0.3f)); // translate it down so it's at the center of the scene
